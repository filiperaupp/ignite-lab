...
export type CretateSubscriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CretateSubscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export type GetLessonSlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, avatarURL: string, bio: string } | null } | null };
...
export const CretateSubscriberDocument = gql`
    mutation CretateSubscriber($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CretateSubscriberMutationFn = Apollo.MutationFunction<CretateSubscriberMutation, CretateSubscriberMutationVariables>;

/**
 * __useCretateSubscriberMutation__
 *
 * To run a mutation, you first call `useCretateSubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCretateSubscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [cretateSubscriberMutation, { data, loading, error }] = useCretateSubscriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCretateSubscriberMutation(baseOptions?: Apollo.MutationHookOptions<CretateSubscriberMutation, CretateSubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CretateSubscriberMutation, CretateSubscriberMutationVariables>(CretateSubscriberDocument, options);
      }
export type CretateSubscriberMutationHookResult = ReturnType<typeof useCretateSubscriberMutation>;
export type CretateSubscriberMutationResult = Apollo.MutationResult<CretateSubscriberMutation>;
export type CretateSubscriberMutationOptions = Apollo.BaseMutationOptions<CretateSubscriberMutation, CretateSubscriberMutationVariables>;
